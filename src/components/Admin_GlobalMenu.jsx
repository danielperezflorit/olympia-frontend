...
const Admin_GlobalMenu = ({ navigation, onClose }) => {
    ...
    const menuRoutes = [
        ...
        { name: 'Admin_Teams', label: t("globalmenu.teams")},
        { name: 'Admin_Competitions', label: t("globalmenu.competitions")},
        { name: 'Admin_Futbol', label: t("globalmenu.football")},
        { name: 'Admin_Padel', label: t("globalmenu.paddle")}, 
        { name: 'Admin_Basquet', label: t("globalmenu.basketball")}, 
        { name: 'Admin_Balonmano', label: t("globalmenu.handball")},
    ];
