...
import { View, ScrollView, Text, Image, StyleSheet, TouchableOpacity, Dimensions, Platform } from 'react-native';
...
const ImageContainer = ({ navigation, source, sportName }) => (
    <TouchableOpacity 
        ...
        onPress={() => {
            if (sportName === 'Futbol') {
                navigation.navigate('Logout_Futbol', { sportName: sportName }); 
            } else if (sportName === 'Padel') {
                navigation.navigate('Logout_Padel', { sportName: sportName });
            } else if (sportName === 'Basquet') {
                navigation.navigate('Logout_Basquet', { sportName: sportName });
            } else if (sportName === 'Balonmano') {
                navigation.navigate('Logout_Balonmano', { sportName: sportName });
            }
        }}
    >
...
export default function Logout_HomeScreen({ navigation }) { 
