        ...
        async function loadInitialData() {
            ...
            try {
                ...
                if (paddleId) {
                    ...
                    console.warn("Deporte 'PÁDEL' no encontrado en la base de datos.");
                    setLoading(false);
                }
            } catch (e) {
                console.error("Error al cargar datos iniciales de Pádel:", e);
                setLoading(false);
            }
        }
        loadInitialData();
                ...
                <ScrollView contentContainerStyle={styles.container}>
                    ...
                    {selectedCompetitionId && (
                        <View style={styles.adminButtons}>
                            ...
                            >
                                <Text style={styles.buttonText}>{t('paddle.new_match')}</Text>
                            </TouchableOpacity>
                        </View>
                    )}
                </ScrollView>
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        ...
                        <TouchableOpacity style={styles.closeButton} onPress={() => setIsMatchFormVisible(false)}>
                            <Text style={styles.closeButtonText}>{t('paddle.close')}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </Modal>
