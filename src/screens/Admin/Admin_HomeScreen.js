...
const ImageContainer = ({ navigation, source, sportName }) => (
    <TouchableOpacity 
        ...
        onPress={() => {
            if (sportName === 'Futbol') {
                navigation.navigate('Admin_Futbol', { sportName: sportName }); 
            } else if (sportName === 'Padel') {
                navigation.navigate('Admin_Padel', { sportName: sportName });
            } else if (sportName === 'Basquet') {
                navigation.navigate('Admin_Basquet', { sportName: sportName });
            } else if (sportName === 'Balonmano') {
                navigation.navigate('Admin_Balonmano', { sportName: sportName });
            }
        }}
    >
...
export default function Admin_HomeScreen({ navigation }) { 
