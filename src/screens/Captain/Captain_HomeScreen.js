...
const ImageContainer = ({ navigation, source, sportName }) => (
    <TouchableOpacity 
        ...
        onPress={() => {
            if (sportName === 'Futbol') {
                navigation.navigate('Captain_Futbol', { sportName: sportName }); 
            } else if (sportName === 'Padel') {
                navigation.navigate('Captain_Padel', { sportName: sportName });
            } else if (sportName === 'Basquet') {
                navigation.navigate('Captain_Basquet', { sportName: sportName });
            } else if (sportName === 'Balonmano') {
                navigation.navigate('Captain_Balonmano', { sportName: sportName });
            }
        }}
    >
...
export default function Captain_HomeScreen({ navigation }) { 
